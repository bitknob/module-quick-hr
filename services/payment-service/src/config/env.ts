...
const getEnvPath = (): string => {
  // Path 1: Relative to this file's location (services/payment-service/src/config -> root)
...
export const getServiceName = (): string => {
  return process.env.SERVICE_NAME || process.env.SERVICE_NAME_PAYMENT || 'payment-service';
};
